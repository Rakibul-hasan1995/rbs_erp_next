...
export default function CustomerStatementPDF({pageData}: {pageData: Statement}) {
      ...
      // <PDFViewer width="100%" height={height || '100vh'}>
         <Document>
            <Page size="A4" style={styles.page} wrap={true}>
               ...
               <Text style={styles.subTitle}>Sub Ladger For: {pageData?.customer}</Text>
               <View style={styles.tableContainer}>
                  <TableHeader cells={tableHeader} />
                  {pageData?.data?.map((item: { page: React.Key | null | undefined; }) =>
