...
export const getOrders = async (customerId: string, url: string) => {
   ...
   try {
      ...
      const expandString = getQueryParams(url, 'expand', false)

      const skip = (page - 1) * limit;
      const expand = expandString === 'true'; // Convert the query parameter to a boolean
